#account setup
username = 'prasanna.mohanasundaram';
password = 'madurai_123';
...
def getUser_input():
    ...
    ccaddress = raw_input("Enter CC email address:     ")
    bccaddress = raw_input("Enter Bcc email address:   ")
    mysubject = raw_input("Enter subject:                 ")
    message = raw_input("Enter message to send:         ")
    return toaddress,ccaddress,bccaddress,mysubject,message

#to be tested...
toaddress,ccaddress,bccaddress,mysubject,message = getUser_input();
print("Sending " + message + " to " + toaddress + " with subject " + mysubject)

compose_email([toaddress,ccaddress,bccaddress],
              mysubject,
              [[message,0]],
              '');

"""
compose_email(['pmohanasundaram@gogoair.com','',''],
              'test v.5.0',
              [['some text goes here...\n',0]],
              '');
"""              
